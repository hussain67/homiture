...
function ConfirmAddItem() {
	...
	return (
		<div className={`absolute -top-3 md:-top-1/5 left-1/2 -translate-x-1/2 border-2 border-slate-300 py-10 px-15 duration-3000 transition-transform bg-muted ${isShowInfo ? "scale-100 " : "scale-0 "}`}>
